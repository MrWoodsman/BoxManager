    ...
    <ThemedView style={{ flex: 1 }} darkColor="#171717">
      <SafeAreaView edges={["top"]} style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        <View>
          ...
          <Text className="text-neutral-500 text-xl">Masz trochę porządkowania?</Text>
        </View>
          ...
          <View className="flex-row flex-wrap -mx-2">
            <View className="w-1/2 px-2">
              <View className="items-center border border-neutral-700 bg-neutral-800/50 p-4 rounded-lg">
                <Text className="text-white text-5xl font-bold">{displayValues.boxNumber}</Text>
            ...
            <View className="w-1/2 px-2">
              <View className="items-center border border-neutral-700 bg-neutral-800/50 p-4 rounded-lg">
                <Text className="text-white text-5xl font-bold">{displayValues.itemNumber}</Text>
